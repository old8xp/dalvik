...
public class CharsetBenchmark extends SimpleBenchmark {
    private static final String STRING = "this is a simple example";
    ...
    public void time_new_String(int reps) throws Exception {
    ...
    public void time_Charset_forName(int reps) throws Exception {
        for (int i = 0; i < reps; ++i) {
